...
This system is designed to be customized by YOU (AI Agent). When the user asks you to change archetypes, adjust scoring, add companies, or modify negotiation scripts -- do it directly. You read the same files you use, so you know exactly what to edit.
...
Default modes are in `modes/` and are English. This repository should use English instructions and workflow files only.
